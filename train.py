...
plt.plot(range(1, n_epochs+1), val_loss_log, label='val loss')
plt.xlabel('epochs')
...
plt.subplot(1, 2, 2)
plt.plot(range(1, n_epochs+1), train_acc_log, label='train acc')
plt.plot(range(1, n_epochs+1), val_acc_log, label='val acc')
plt.xlabel('epochs')
plt.xticks(range(1, n_epochs+1))
plt.ylabel('accuracy')
plt.grid()
